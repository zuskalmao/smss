        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-dark flex items-center justify-center text-white/70 hover:text-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#nft-messaging" className="text-white/70 hover:text-white transition-colors">NFT Messaging</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-white/70 hover:text-white transition-colors">How to Buy</a></li>
              <li><a href="#" className="text-white/70 hover:text-white transition-colors">Documentation</a></li>
              <li><a href="#" className="text-white/70 hover:text-white transition-colors">Developers</a></li>
